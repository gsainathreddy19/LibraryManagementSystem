                  ...
                  child: Column(
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: (){
                            setState(() {
                              ...
                              print(isSecondLayer);
                              if(isSecondLayer){rotation = 0;isThirdLayer=false;}
                              else{rotation = 0.15;}
                            });
                          },
                          color: black,
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: (){
                            setState(() {
                              ...
                              if(isThirdLayer){rotation = 0;isSecondLayer=false;}
                              else{rotation = 0.15;}
                            });
                          },
                          color: black,
                    ...
                    Transform.rotate(
                      angle: -rotation,
                        ...
                        width: 200,
                        child: RaisedButton(
                          child: Text('day/night',style: TextStyle(color: white),),
                          onPressed: (){
                            setState(() {
                              Color temp = white;
                              white = black;
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        alignment: Alignment.center,
                        child: Text('Sign Up',style: TextStyle(color: white,fontSize: 22),),
                      ),
                      SizedBox(height: 20,),
                      SizedBox(
                        height: 40,
                        ...
                        child: Theme(
                          ...
                          data: new ThemeData(
                            ...
                            decoration: InputDecoration(
                              errorText: isFullNameValid ? null : 'fill your name',
                    ...
                    SizedBox(
                      ...
                      onPressed: (){
                        setState(() {
                          ...
                          bool e = confirmPasswordController.text.isNotEmpty;
                          ...
                          if (a && b && c && d && e && f){
                            if(passwordController.text == confirmPasswordController.text){
                              ...
                              http.get('http://127.0.0.1:5000/signup/'+attach);
                            }
                            else {return _showMyDialog('Password not match');}
                          }
                          else {return _showMyDialog('fill all details');}
                        });
                   ...
                   child: SizedBox(
                      ...
                      onPressed: () async {
                        ...
                        if(usernameController.text.isNotEmpty && passwordController.text.isNotEmpty)  {
                          //UserEmail ex;
                          final response = await http.get('http://127.0.0.1:5000/login/'+usernameController.text);
                          if(passwordController.text == json.decode(response.body)['password']){
                            final userEmail = usernameController.text;
                            UserEmail ex = UserEmail.getUser(userEmail);
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => HomePage(user:ex))
                            );
                            
                          }
                          else{await _showMyDialog('username/password incorrect');}
                        }
                        else{await _showMyDialog('Username/password empty');}
                      },
                        ),
                    ),
                  )
