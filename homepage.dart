          ...
          child: Container(
                     ...
                     child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          Row(children:<Widget>[Icon(Icons.keyboard_return,color:white),SizedBox(width: 4,),Text('Return',style: TextStyle(color: white,fontSize: 16),)]),SizedBox(height: 6,width: 0,),
                          Row(children:<Widget>[Icon(Icons.swap_vertical_circle,color:white),SizedBox(width: 4,),Text('pending',style: TextStyle(color: white,fontSize: 16),)]),SizedBox(height: 6,width: 0,),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('Advanced',style: TextStyle(color: white,fontSize: 22),),SizedBox(height: 6,),
